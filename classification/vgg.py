...
def makeVgg(name):
    ...
    if name == 'vgg11_bn':
        model = VGG(make_layers(cfgs['A'], batch_norm=True))
    if name == 'vgg13':
        model = VGG(make_layers(cfgs['B'], batch_norm=False))
    if name == 'vgg13_bn':
        model = VGG(make_layers(cfgs['B'], batch_norm=True))
    if name == 'vgg16':
    ...
    if name == 'vgg19_bn':
        model = VGG(make_layers(cfgs['E'], batch_norm=True))
    return model
